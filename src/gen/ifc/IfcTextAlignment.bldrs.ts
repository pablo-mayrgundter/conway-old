...
export const IfcTextAlignmentSize = 4;

export function IfcTextAlignmentSerializer( value?: IfcTextAlignment, to: SmartBuffer, offset?: number ): void
{
    if ( value == undefined ) 
    {
        to.writeUInt32LE( 0 );
...
export function IfcTextAlignmentDeserializer( value?: IfcTextAlignment, from: SnapshotBuffer< SchemaSpecificationIFC >, offset?: number ): void
{
    ( () => { 
