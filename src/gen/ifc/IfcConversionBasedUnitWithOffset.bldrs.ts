...
{    
    ...
    public get ConversionOffset() : number
    {
        ...
        {
            this.ConversionOffset_ = (() => { this.guaranteeVTable();
    ...
    public static readonly query = [ EntityTypesIfc.IFCCONVERSIONBASEDUNITWITHOFFSET ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCCONVERSIONBASEDUNITWITHOFFSET;
}
