...
export const IfcPresentableTextSize = 4;

export function IfcPresentableTextSerializer( value?: IfcPresentableText, to: SmartBuffer, offset?: number ): void
{
    if ( value == undefined ) 
    {
        to.writeUInt32LE( 0 );
...
export function IfcPresentableTextDeserializer( value?: IfcPresentableText, from: SnapshotBuffer< SchemaSpecificationIFC >, offset?: number ): void
{
    ( () => { 
...
export default IfcPresentableText;