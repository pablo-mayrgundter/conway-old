...
{    
    ...
    public static readonly query = [ EntityTypesIfc.IFCSTRUCTURALPOINTACTION ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCSTRUCTURALPOINTACTION;
}
