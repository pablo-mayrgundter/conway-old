...
{    
    ...
    public static readonly query = [ EntityTypesIfc.IFCELECTRICAPPLIANCE ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCELECTRICAPPLIANCE;
}
