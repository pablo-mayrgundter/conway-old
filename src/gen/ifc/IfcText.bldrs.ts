...
export const IfcTextSize = 4;

export function IfcTextSerializer( value?: IfcText, to: SmartBuffer, offset?: number ): void
{
    if ( value == undefined ) 
    {
        to.writeUInt32LE( 0 );
...
export function IfcTextDeserializer( value?: IfcText, from: SnapshotBuffer< SchemaSpecificationIFC >, offset?: number ): void
{
    ( () => { 
