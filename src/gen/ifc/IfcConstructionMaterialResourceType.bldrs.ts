...
{    
    ...
    public static readonly query = [ EntityTypesIfc.IFCCONSTRUCTIONMATERIALRESOURCETYPE ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCCONSTRUCTIONMATERIALRESOURCETYPE;
}
