...
import IfcMemberTypeEnum, { IfcMemberTypeEnumDeserializeStep } from "./IfcMemberTypeEnum.bldrs"
...
{    
    ...
    public get PredefinedType() : IfcMemberTypeEnum
    {
        if ( this.PredefinedType_ === void 0 )
        {
            ...
            let value = IfcMemberTypeEnumDeserializeStep( buffer, cursor, endCursor );
