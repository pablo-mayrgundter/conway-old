 ...
 */
export default  class IfcSurfaceStyleWithTextures extends EntityBase< SchemaSpecificationIFC > 
{    
    public readonly specification: IfcSurfaceStyleWithTexturesSpecification = IfcSurfaceStyleWithTexturesSpecification.instance;
...
export class IfcSurfaceStyleWithTexturesSpecification implements ComponentSpecification
{
    ...
    public readonly required: ReadonlyArray< string > = [ 'IfcSurfaceStyleWithTextures' ];
