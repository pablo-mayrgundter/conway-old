...
{    
    ...
    public get TypeIdentifier() : string | null
    {
        ...
        {
            this.TypeIdentifier_ = (() => { this.guaranteeVTable();
    ...
    public get AttributeIdentifier() : string | null
    {
        ...
        {
            this.AttributeIdentifier_ = (() => { this.guaranteeVTable();
    ...
    public get InstanceName() : string | null
    {
        ...
        {
            this.InstanceName_ = (() => { this.guaranteeVTable();
    ...
    public get ListPositions() : Array< number > | null
    {
        ...
        {
            this.ListPositions_ = (() => { this.guaranteeVTable();
...
return value; })();
    ...
    public get InnerReference() : IfcReference | null
    {
        ...
        {
            this.InnerReference_ = (() => { this.guaranteeVTable();
