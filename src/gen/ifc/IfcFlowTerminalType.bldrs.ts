 ...
 */
export default abstract class IfcFlowTerminalType extends IfcDistributionFlowElementType 
{    
    public readonly specification: IfcFlowTerminalTypeSpecification = IfcFlowTerminalTypeSpecification.instance;
