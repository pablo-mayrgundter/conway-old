...
{    
    ...
    public get FamilyName() : IfcLabel | null
    {
        ...
        {
            this.FamilyName_ = (() => { this.guaranteeVTable();
    ...
    public get GivenName() : IfcLabel | null
    {
        ...
        {
            this.GivenName_ = (() => { this.guaranteeVTable();
    ...
    public get MiddleNames() : Array<IfcLabel> | null
    {
        ...
        {
            this.MiddleNames_ = (() => { this.guaranteeVTable();
    ...
    public get PrefixTitles() : Array<IfcLabel> | null
    {
        ...
        {
            this.PrefixTitles_ = (() => { this.guaranteeVTable();
    ...
    public get SuffixTitles() : Array<IfcLabel> | null
    {
        ...
        {
            this.SuffixTitles_ = (() => { this.guaranteeVTable();
        ...
        if ( this.Addresses_ === void 0 )
        {
            ...
            for ( let address of stepExtractArray( buffer, cursor, endCursor ) )
            {
                value.push( (() => { 
                    ...
                    if ( value === void 0 || !( value instanceof IfcAddress ) )
                    {                
                        throw new Error( 'Value in STEP was incorrectly typed for field' );
                    };
