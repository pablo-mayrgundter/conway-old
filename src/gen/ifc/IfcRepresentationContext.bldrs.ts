...
export  class IfcRepresentationContext extends StepEntityBase< EntityTypesIfc > 
{    
    ...
    public get ContextIdentifier() : IfcLabel | null
    {
        ...
        {
            this.ContextIdentifier_ = (() => { this.guaranteeVTable();
    ...
    public get ContextType() : IfcLabel | null
    {
        ...
        {
            this.ContextType_ = (() => { this.guaranteeVTable();
