...
{    
    ...
    public static readonly query = [ EntityTypesIfc.IFCLABORRESOURCETYPE ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCLABORRESOURCETYPE;
}
