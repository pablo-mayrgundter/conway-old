...
{    
    ...
    public static readonly query = [ EntityTypesIfc.IFCROUNDEDRECTANGLEPROFILEDEF ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCROUNDEDRECTANGLEPROFILEDEF;
}
