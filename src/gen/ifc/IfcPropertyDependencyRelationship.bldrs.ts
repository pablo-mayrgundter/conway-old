...
export  class IfcPropertyDependencyRelationship extends StepEntityBase< EntityTypesIfc > 
{    
    ...
    public get DependingProperty() : IfcProperty
    {
        ...
        {
            this.DependingProperty_ = (() => { this.guaranteeVTable();
    ...
    public get DependantProperty() : IfcProperty
    {
        ...
        {
            this.DependantProperty_ = (() => { this.guaranteeVTable();
