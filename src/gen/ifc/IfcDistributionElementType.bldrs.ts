 ...
 */
export default  class IfcDistributionElementType extends IfcElementType 
{    
    public readonly specification: IfcDistributionElementTypeSpecification = IfcDistributionElementTypeSpecification.instance;
