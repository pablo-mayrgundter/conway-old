 ...
 */
export default  class IfcTableRow extends EntityBase< SchemaSpecificationIFC > 
{    
    public readonly specification: IfcTableRowSpecification = IfcTableRowSpecification.instance;
...
export class IfcTableRowSpecification implements ComponentSpecification
{
    ...
    public readonly required: ReadonlyArray< string > = [ 'IfcTableRow' ];
