...
export class IfcTableRowSpecification implements ComponentSpecification
{
    ...
    public static readonly instance: IfcTableRowSpecification = new IfcTableRowSpecification();
}
