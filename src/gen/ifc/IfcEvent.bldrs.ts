...
{    
    ...
    public get EventTriggerType() : IfcEventTriggerTypeEnum | null
    {
        ...
        {
            this.EventTriggerType_ = (() => { this.guaranteeVTable();
    ...
    public get UserDefinedEventTriggerType() : string | null
    {
        ...
        {
            this.UserDefinedEventTriggerType_ = (() => { this.guaranteeVTable();
    ...
    public get EventOccurenceTime() : IfcEventTime | null
    {
        ...
        {
            this.EventOccurenceTime_ = (() => { this.guaranteeVTable();
    ...
    public static readonly query = [ EntityTypesIfc.IFCEVENT ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCEVENT;
}
