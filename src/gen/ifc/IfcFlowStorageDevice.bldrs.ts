...
export default class IfcFlowStorageDevice implements Component< SchemaSpecificationIFC > 
{
    ...
    public readonly __specification__: IfcFlowStorageDeviceSpecification = IfcFlowStorageDeviceSpecification.instance;
...
export class IfcFlowStorageDeviceSpecification implements ComponentSpecification
{
    ...
    public static readonly instance: IfcFlowStorageDeviceSpecification = new IfcFlowStorageDeviceSpecification();
}
