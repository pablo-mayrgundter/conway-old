...
import IfcRoleEnum, { IfcRoleEnumDeserializeStep } from "./IfcRoleEnum.bldrs"
...
export default  class IfcActorRole extends StepEntityBase< EntityTypesIfc > 
{    
    ...
    public get Role() : IfcRoleEnum
    {
        if ( this.Role_ === void 0 )
        {
            ...
            let value = IfcRoleEnumDeserializeStep( buffer, cursor, endCursor );
    ...
    public get UserDefinedRole() : IfcLabel | null
    {
        if ( this.UserDefinedRole_ === void 0 )
        {
            ...
            {
                throw new Error( "Couldn't read field UserDefinedRole due to too few fields in record" ); 
            }
            ...
            if ( value !== void 0 )
            {
                ...
                {
                    throw new Error( 'Value in STEP was incorrectly typed for field UserDefinedRole' );
                }

                this.UserDefinedRole_ = null;                
            }
            else
            {
                this.UserDefinedRole_ = value;
            }
        }
