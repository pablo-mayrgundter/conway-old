...
{    
    ...
    private PunchList_? : Array< string > | null;

    public get MoveFrom() : IfcSpatialStructureElement
    {
        if ( this.MoveFrom_ === void 0 )
        {
            this.MoveFrom_ = (() => { this.guaranteeVTable();
    ...
    public get MoveTo() : IfcSpatialStructureElement
    {
        ...
        {
            this.MoveTo_ = (() => { this.guaranteeVTable();
    ...
    public get PunchList() : Array< string > | null
    {
        if ( this.PunchList_ === void 0 )
        {
            this.PunchList_ = (() => { this.guaranteeVTable();
        ...
        return this.PunchList_ as Array< string > | null;
    }
