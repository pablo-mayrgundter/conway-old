...
{    
    ...
    public get FlangeEdgeRadius() : number | null
    {
        ...
        {
            this.FlangeEdgeRadius_ = (() => { this.guaranteeVTable();
    ...
    public get WebEdgeRadius() : number | null
    {
        ...
        {
            this.WebEdgeRadius_ = (() => { this.guaranteeVTable();
    ...
    public get WebSlope() : number | null
    {
        ...
        {
            this.WebSlope_ = (() => { this.guaranteeVTable();
    ...
    public get FlangeSlope() : number | null
    {
        ...
        {
            this.FlangeSlope_ = (() => { this.guaranteeVTable();
    ...
    public static readonly query = [ EntityTypesIfc.IFCTSHAPEPROFILEDEF ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCTSHAPEPROFILEDEF;
}
