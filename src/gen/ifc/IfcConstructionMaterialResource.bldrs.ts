...
{    
    ...
    public static readonly query = [ EntityTypesIfc.IFCCONSTRUCTIONMATERIALRESOURCE ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCCONSTRUCTIONMATERIALRESOURCE;
}
