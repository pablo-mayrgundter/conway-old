 ...
 */
export default class IfcStructuralLoadStatic implements Component< SchemaSpecificationIFC > 
{
    public readonly __type__ = 'IfcStructuralLoadStatic';

    public readonly __version__: number = 0;

    public readonly __specification__: IfcStructuralLoadStaticSpecification = IfcStructuralLoadStaticSpecification.instance;
...
export class IfcStructuralLoadStaticSpecification implements ComponentSpecification
{
    ...
    public readonly required: ReadonlyArray< string > = [ 'IfcStructuralLoad' ];
