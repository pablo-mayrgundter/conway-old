...
{    
    public readonly specification: IfcCostItemSpecification = IfcCostItemSpecification.instance;
...
export class IfcCostItemSpecification implements ComponentSpecification
{
    ...
    public readonly required: ReadonlyArray< string > = [ 'IfcCostItem', 'IfcControl', 'IfcObject', 'IfcObjectDefinition', 'IfcRoot' ];
