...
{    
    public readonly specification: IfcWorkPlanSpecification = IfcWorkPlanSpecification.instance;
...
export class IfcWorkPlanSpecification implements ComponentSpecification
{
    ...
    public readonly required: ReadonlyArray< string > = [ 'IfcWorkPlan', 'IfcWorkControl', 'IfcControl', 'IfcObject', 'IfcObjectDefinition', 'IfcRoot' ];
