 ...
 */
export default abstract class IfcFeatureElement extends IfcElement 
{    
    public readonly specification: IfcFeatureElementSpecification = IfcFeatureElementSpecification.instance;
