...
{    
    public readonly specification: IfcElectricalElementSpecification = IfcElectricalElementSpecification.instance;
...
export class IfcElectricalElementSpecification implements ComponentSpecification
{
    ...
    public readonly required: ReadonlyArray< string > = [ 'IfcElectricalElement', 'IfcElement', 'IfcProduct', 'IfcObject', 'IfcObjectDefinition', 'IfcRoot' ];
