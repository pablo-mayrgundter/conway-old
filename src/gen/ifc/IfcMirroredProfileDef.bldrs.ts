...
{    
    ...
    public static readonly query = [ EntityTypesIfc.IFCMIRROREDPROFILEDEF ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCMIRROREDPROFILEDEF;
}
