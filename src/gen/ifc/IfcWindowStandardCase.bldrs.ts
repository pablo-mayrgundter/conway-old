...
{    
    ...
    public static readonly query = [ EntityTypesIfc.IFCWINDOWSTANDARDCASE ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCWINDOWSTANDARDCASE;
}
