...
let gMapIfcSensorTypeEnum = new Int32Array( [1,32,74,1,903,21] );

let prefixSumAddressIfcSensorTypeEnum = new Uint32Array( [0,19,43,56,69,87,99,115,127,146,162,173,189,201,212,222,234,247,260,273,288,301,318,328,349,365,377] );

let slotMapIfcSensorTypeEnum = new Int32Array( [2,11,21,20,10,5,17,4,22,9,1,14,25,7,0,8,6,13,12,3,24,18,16,19,15,23] );

let encodedDataIfcSensorTypeEnum = (new TextEncoder()).encode( ".CONDUCTANCESENSOR..IONCONCENTRATIONSENSOR..SOUNDSENSOR..SMOKESENSOR..IDENTIFIERSENSOR..FLOWSENSOR..PRESSURESENSOR..FIRESENSOR..TEMPERATURESENSOR..HUMIDITYSENSOR..CO2SENSOR..MOISTURESENSOR..NOTDEFINED..GASSENSOR..COSENSOR..HEATSENSOR..FROSTSENSOR..LIGHTSENSOR..LEVELSENSOR..CONTACTSENSOR..USERDEFINED..RADIATIONSENSOR..PHSENSOR..RADIOACTIVITYSENSOR..MOVEMENTSENSOR..WINDSENSOR." );
