...
return value; })();
    ...
    public static readonly query = [ EntityTypesIfc.IFCPROPERTYENUMERATEDVALUE ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCPROPERTYENUMERATEDVALUE;
}
