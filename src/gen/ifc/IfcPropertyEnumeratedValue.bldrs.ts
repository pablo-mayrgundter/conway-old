...
export class IfcPropertyEnumeratedValueSpecification implements ComponentSpecification
{
    public readonly name: string = 'IfcPropertyEnumeratedValue';

    public readonly required: ReadonlyArray< string > = [ 'IfcPropertyEnumeratedValue', 'IfcSimpleProperty', 'IfcProperty' ];
    ...
    [
		...
		}, 
		{
			...
			isCollection: false,
			rank: 0,
			baseType: 'IfcPropertyEnumeration',
			optional: true
		}
    ];
    ...
    public static readonly instance: IfcPropertyEnumeratedValueSpecification = new IfcPropertyEnumeratedValueSpecification();
}
