...
{    
    ...
    public get LinearStiffnessByLengthX() : IfcModulusOfLinearSubgradeReactionMeasure | null
    {
        if ( this.LinearStiffnessByLengthX_ === void 0 )
        {
            ...
            {
                throw new Error( "Couldn't read field LinearStiffnessByLengthX due to too few fields in record" ); 
            }
            ...
            if ( value !== void 0 )
            {
                ...
                {
                    throw new Error( 'Value in STEP was incorrectly typed for field LinearStiffnessByLengthX' );
                }

                this.LinearStiffnessByLengthX_ = null;                
            }
            else
            {
                this.LinearStiffnessByLengthX_ = value;
            }
        }
    ...
    public get LinearStiffnessByLengthY() : IfcModulusOfLinearSubgradeReactionMeasure | null
    {
        if ( this.LinearStiffnessByLengthY_ === void 0 )
        {
            ...
            {
                throw new Error( "Couldn't read field LinearStiffnessByLengthY due to too few fields in record" ); 
            }
            ...
            if ( value !== void 0 )
            {
                if ( stepExtractOptional( buffer, cursor, endCursor ) !== null )
                {
                    throw new Error( 'Value in STEP was incorrectly typed for field LinearStiffnessByLengthY' );
                }

                this.LinearStiffnessByLengthY_ = null;                
            }
            else
            {
                this.LinearStiffnessByLengthY_ = value;
            }
        }
    ...
    public get LinearStiffnessByLengthZ() : IfcModulusOfLinearSubgradeReactionMeasure | null
    {
        if ( this.LinearStiffnessByLengthZ_ === void 0 )
        {
            ...
            {
                throw new Error( "Couldn't read field LinearStiffnessByLengthZ due to too few fields in record" ); 
            }
            ...
            if ( value !== void 0 )
            {
                if ( stepExtractOptional( buffer, cursor, endCursor ) !== null )
                {
                    throw new Error( 'Value in STEP was incorrectly typed for field LinearStiffnessByLengthZ' );
                }

                this.LinearStiffnessByLengthZ_ = null;                
            }
            else
            {
                this.LinearStiffnessByLengthZ_ = value;
            }
        }
    ...
    public get RotationalStiffnessByLengthX() : IfcModulusOfRotationalSubgradeReactionMeasure | null
    {
        if ( this.RotationalStiffnessByLengthX_ === void 0 )
        {
            ...
            {
                throw new Error( "Couldn't read field RotationalStiffnessByLengthX due to too few fields in record" ); 
            }
            ...
            if ( value !== void 0 )
            {
                if ( stepExtractOptional( buffer, cursor, endCursor ) !== null )
                {
                    throw new Error( 'Value in STEP was incorrectly typed for field RotationalStiffnessByLengthX' );
                }

                this.RotationalStiffnessByLengthX_ = null;                
            }
            else
            {
                this.RotationalStiffnessByLengthX_ = value;
            }
        }
    ...
    public get RotationalStiffnessByLengthY() : IfcModulusOfRotationalSubgradeReactionMeasure | null
    {
        if ( this.RotationalStiffnessByLengthY_ === void 0 )
        {
            ...
            {
                throw new Error( "Couldn't read field RotationalStiffnessByLengthY due to too few fields in record" ); 
            }
            ...
            if ( value !== void 0 )
            {
                if ( stepExtractOptional( buffer, cursor, endCursor ) !== null )
                {
                    throw new Error( 'Value in STEP was incorrectly typed for field RotationalStiffnessByLengthY' );
                }

                this.RotationalStiffnessByLengthY_ = null;                
            }
            else
            {
                this.RotationalStiffnessByLengthY_ = value;
            }
        }
    ...
    public get RotationalStiffnessByLengthZ() : IfcModulusOfRotationalSubgradeReactionMeasure | null
    {
        if ( this.RotationalStiffnessByLengthZ_ === void 0 )
        {
            ...
            {
                throw new Error( "Couldn't read field RotationalStiffnessByLengthZ due to too few fields in record" ); 
            }
            ...
            if ( value !== void 0 )
            {
                if ( stepExtractOptional( buffer, cursor, endCursor ) !== null )
                {
                    throw new Error( 'Value in STEP was incorrectly typed for field RotationalStiffnessByLengthZ' );
                }

                this.RotationalStiffnessByLengthZ_ = null;                
            }
            else
            {
                this.RotationalStiffnessByLengthZ_ = value;
            }
        }
