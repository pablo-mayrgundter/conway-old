...
{    
    ...
    public get VolumeValue() : IfcVolumeMeasure
    {
        if ( this.VolumeValue_ === void 0 )
        {
            ...
            {
                throw new Error( "Couldn't read field VolumeValue due to too few fields in record" ); 
            }
            ...
            if ( value === void 0 )
            {                
                throw new Error( 'Value in STEP was incorrectly typed for field VolumeValue' );
            };

            this.VolumeValue_ = value;
        }
