...
let gMapIfcObjectiveEnum = new Int32Array( [6,31,4,3] );

let prefixSumAddressIfcObjectiveEnum = new Uint32Array( [0,16,30,43,61,72,87,104,115,125,137,149,162,177] );

let slotMapIfcObjectiveEnum = new Int32Array( [0,2,11,10,6,9,4,7,3,1,12,8,5] );

let encodedDataIfcObjectiveEnum = (new TextEncoder()).encode( ".CODECOMPLIANCE..DESIGNINTENT..USERDEFINED..TRIGGERCONDITION..MODELVIEW..SPECIFICATION..HEALTHANDSAFETY..PARAMETER..EXTERNAL..CODEWAIVER..NOTDEFINED..REQUIREMENT..MERGECONFLICT." );
