...
export  class IfcClassificationNotation extends StepEntityBase< EntityTypesIfc > 
{    
    ...
    public get NotationFacets() : Array<IfcClassificationNotationFacet>
    {
        ...
        {
            this.NotationFacets_ = (() => { this.guaranteeVTable();
            ...
            let value : Array<IfcClassificationNotationFacet> = [];
            ...
            for ( let address of stepExtractArray( buffer, cursor, endCursor ) )
            {
                value.push( (() => { 
                    ...
                    if ( !( value instanceof IfcClassificationNotationFacet ) )
                    {                
