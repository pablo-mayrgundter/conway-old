...
{    
    ...
    public get RelatedObjects() : Array<IfcObject>
    {
        ...
        {
            this.RelatedObjects_ = (() => { this.guaranteeVTable();
...
return value; })();
    ...
    public get RelatingObject() : IfcObject
    {
        ...
        {
            this.RelatingObject_ = (() => { this.guaranteeVTable();
    ...
    public static readonly query = [ EntityTypesIfc.IFCRELDEFINESBYOBJECT ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCRELDEFINESBYOBJECT;
}
