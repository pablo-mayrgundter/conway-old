 ...
 */
export default abstract class IfcPreDefinedSymbol extends IfcPreDefinedItem 
{    
    public readonly specification: IfcPreDefinedSymbolSpecification = IfcPreDefinedSymbolSpecification.instance;
