...
{    
    ...
    public get BoilingPoint() : IfcThermodynamicTemperatureMeasure | null
    {
        if ( this.BoilingPoint_ === void 0 )
        {
            ...
            {
                throw new Error( "Couldn't read field BoilingPoint due to too few fields in record" ); 
            }
            ...
            if ( value !== void 0 )
            {
                if ( stepExtractOptional( buffer, cursor, endCursor ) !== null )
                {
                    throw new Error( 'Value in STEP was incorrectly typed for field BoilingPoint' );
                }

                this.BoilingPoint_ = null;                
            }
            else
            {
                this.BoilingPoint_ = value;
            }
        }
    ...
    public get FreezingPoint() : IfcThermodynamicTemperatureMeasure | null
    {
        if ( this.FreezingPoint_ === void 0 )
        {
            ...
            {
                throw new Error( "Couldn't read field FreezingPoint due to too few fields in record" ); 
            }
            ...
            if ( value !== void 0 )
            {
                if ( stepExtractOptional( buffer, cursor, endCursor ) !== null )
                {
                    throw new Error( 'Value in STEP was incorrectly typed for field FreezingPoint' );
                }

                this.FreezingPoint_ = null;                
            }
            else
            {
                this.FreezingPoint_ = value;
            }
        }
    ...
    public get ThermalConductivity() : IfcThermalConductivityMeasure | null
    {
        if ( this.ThermalConductivity_ === void 0 )
        {
            ...
            {
                throw new Error( "Couldn't read field ThermalConductivity due to too few fields in record" ); 
            }
            ...
            if ( value !== void 0 )
            {
                if ( stepExtractOptional( buffer, cursor, endCursor ) !== null )
                {
                    throw new Error( 'Value in STEP was incorrectly typed for field ThermalConductivity' );
                }

                this.ThermalConductivity_ = null;                
            }
            else
            {
                this.ThermalConductivity_ = value;
            }
        }
