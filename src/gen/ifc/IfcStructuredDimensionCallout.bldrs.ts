 ...
 */
export default  class IfcStructuredDimensionCallout extends IfcDraughtingCallout 
{    
    public readonly specification: IfcStructuredDimensionCalloutSpecification = IfcStructuredDimensionCalloutSpecification.instance;
...
export class IfcStructuredDimensionCalloutSpecification implements ComponentSpecification
{
    ...
    public readonly required: ReadonlyArray< string > = [ 'IfcStructuredDimensionCallout', 'IfcDraughtingCallout', 'IfcGeometricRepresentationItem', 'IfcRepresentationItem' ];
