...
{    
    ...
    public static readonly query = [ EntityTypesIfc.IFCSTRUCTURALSURFACECONNECTION ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCSTRUCTURALSURFACECONNECTION;
}
