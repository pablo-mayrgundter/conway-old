 ...
 */
export default  class IfcFlowController extends IfcDistributionFlowElement 
{    
    public readonly specification: IfcFlowControllerSpecification = IfcFlowControllerSpecification.instance;
