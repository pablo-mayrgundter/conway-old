...
export  class IfcVertexBasedTextureMap extends StepEntityBase< EntityTypesIfc > 
{    
    ...
    public get TextureVertices() : Array<IfcTextureVertex>
    {
        ...
        {
            this.TextureVertices_ = (() => { this.guaranteeVTable();
    ...
    public get TexturePoints() : Array<IfcCartesianPoint>
    {
        ...
        {
            this.TexturePoints_ = (() => { this.guaranteeVTable();
