 ...
 */
export default abstract class IfcFlowMovingDeviceType extends IfcDistributionFlowElementType 
{    
    public readonly specification: IfcFlowMovingDeviceTypeSpecification = IfcFlowMovingDeviceTypeSpecification.instance;
