...
export default  class IfcApprovalRelationship extends StepEntityBase< EntityTypesIfc > 
{    
    ...
    public get RelatedApproval() : IfcApproval
    {
        if ( this.RelatedApproval_ === void 0 )
        {
            this.RelatedApproval_ = (() => { this.guaranteeVTable();
        ...
        return this.RelatedApproval_ as IfcApproval;
    }
