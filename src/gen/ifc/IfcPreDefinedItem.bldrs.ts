 ...
 */
export default abstract class IfcPreDefinedItem extends EntityBase< SchemaSpecificationIFC > 
{    
    public readonly specification: IfcPreDefinedItemSpecification = IfcPreDefinedItemSpecification.instance;
