...
{    
    ...
    public get ReferencePath() : IfcReference | null
    {
        ...
        {
            this.ReferencePath_ = (() => { this.guaranteeVTable();
    ...
    public static readonly query = [ EntityTypesIfc.IFCMETRIC ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCMETRIC;
}
