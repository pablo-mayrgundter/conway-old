...
import { IfcAheadOrBehind, IfcAheadOrBehindDeserializeStep } from "./index"
...
export  class IfcCoordinatedUniversalTimeOffset extends StepEntityBase< EntityTypesIfc > 
{    
    ...
    private HourOffset_? : number;
    private MinuteOffset_? : number | null;
    ...
    public get HourOffset() : number
    {
        ...
        {
            this.HourOffset_ = (() => { this.guaranteeVTable();
        ...
        return this.HourOffset_ as number;
    }

    public get MinuteOffset() : number | null
    {
        if ( this.MinuteOffset_ === void 0 )
        {
            this.MinuteOffset_ = (() => { this.guaranteeVTable();
        ...
        return this.MinuteOffset_ as number | null;
    }
    ...
    public get Sense() : IfcAheadOrBehind
    {
        ...
        {
            this.Sense_ = (() => { this.guaranteeVTable();
