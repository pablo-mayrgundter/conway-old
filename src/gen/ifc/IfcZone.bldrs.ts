 ...
 */
export default  class IfcZone extends IfcGroup 
{    
    public readonly specification: IfcZoneSpecification = IfcZoneSpecification.instance;
...
export class IfcZoneSpecification implements ComponentSpecification
{
    ...
    public readonly required: ReadonlyArray< string > = [ 'IfcZone', 'IfcGroup', 'IfcObject', 'IfcObjectDefinition', 'IfcRoot' ];
