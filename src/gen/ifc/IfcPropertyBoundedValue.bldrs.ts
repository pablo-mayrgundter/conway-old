...
export class IfcPropertyBoundedValueSpecification implements ComponentSpecification
{
    public readonly name: string = 'IfcPropertyBoundedValue';

    public readonly required: ReadonlyArray< string > = [ 'IfcPropertyBoundedValue', 'IfcSimpleProperty', 'IfcProperty' ];
    ...
    public static readonly instance: IfcPropertyBoundedValueSpecification = new IfcPropertyBoundedValueSpecification();
}
