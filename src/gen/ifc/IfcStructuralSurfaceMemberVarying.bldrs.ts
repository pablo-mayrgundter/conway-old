...
{    
    ...
    public static readonly query = [ EntityTypesIfc.IFCSTRUCTURALSURFACEMEMBERVARYING ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCSTRUCTURALSURFACEMEMBERVARYING;
}
