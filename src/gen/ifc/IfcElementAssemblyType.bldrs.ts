...
{    
    ...
    public static readonly query = [ EntityTypesIfc.IFCELEMENTASSEMBLYTYPE ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCELEMENTASSEMBLYTYPE;
}
