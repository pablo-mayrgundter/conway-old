...
export  class IfcOrganizationRelationship extends StepEntityBase< EntityTypesIfc > 
{    
    ...
    public get RelatingOrganization() : IfcOrganization
    {
        ...
        {
            this.RelatingOrganization_ = (() => { this.guaranteeVTable();
    ...
    public get RelatedOrganizations() : Array<IfcOrganization>
    {
        ...
        {
            this.RelatedOrganizations_ = (() => { this.guaranteeVTable();
