...
{    
    ...
    public get ScheduleWork() : string | null
    {
        ...
        {
            this.ScheduleWork_ = (() => { this.guaranteeVTable();
    ...
    public get ScheduleUsage() : number | null
    {
        ...
        {
            this.ScheduleUsage_ = (() => { this.guaranteeVTable();
    ...
    public get ScheduleContour() : string | null
    {
        ...
        {
            this.ScheduleContour_ = (() => { this.guaranteeVTable();
    ...
    public get LevelingDelay() : string | null
    {
        ...
        {
            this.LevelingDelay_ = (() => { this.guaranteeVTable();
    ...
    public get IsOverAllocated() : boolean | null
    {
        ...
        {
            this.IsOverAllocated_ = (() => { this.guaranteeVTable();
    ...
    public get ActualWork() : string | null
    {
        ...
        {
            this.ActualWork_ = (() => { this.guaranteeVTable();
    ...
    public get ActualUsage() : number | null
    {
        ...
        {
            this.ActualUsage_ = (() => { this.guaranteeVTable();
    ...
    public get RemainingWork() : string | null
    {
        ...
        {
            this.RemainingWork_ = (() => { this.guaranteeVTable();
    ...
    public get RemainingUsage() : number | null
    {
        ...
        {
            this.RemainingUsage_ = (() => { this.guaranteeVTable();
