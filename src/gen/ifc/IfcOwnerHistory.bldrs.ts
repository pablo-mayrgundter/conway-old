...
{    
    ...
    public get OwningUser() : IfcPersonAndOrganization
    {
        ...
        {
            this.OwningUser_ = (() => { this.guaranteeVTable();
    ...
    public get OwningApplication() : IfcApplication
    {
        ...
        {
            this.OwningApplication_ = (() => { this.guaranteeVTable();
    ...
    public get State() : IfcStateEnum | null
    {
        ...
        {
            this.State_ = (() => { this.guaranteeVTable();
    ...
    public get ChangeAction() : IfcChangeActionEnum
    {
        ...
        {
            this.ChangeAction_ = (() => { this.guaranteeVTable();
    ...
    public get LastModifiedDate() : number | null
    {
        ...
        {
            this.LastModifiedDate_ = (() => { this.guaranteeVTable();
    ...
    public get LastModifyingUser() : IfcPersonAndOrganization | null
    {
        ...
        {
            this.LastModifyingUser_ = (() => { this.guaranteeVTable();
    ...
    public get LastModifyingApplication() : IfcApplication | null
    {
        ...
        {
            this.LastModifyingApplication_ = (() => { this.guaranteeVTable();
