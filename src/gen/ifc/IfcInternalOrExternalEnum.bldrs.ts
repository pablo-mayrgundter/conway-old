...
let gMapIfcInternalOrExternalEnum = new Int32Array( [107] );

let prefixSumAddressIfcInternalOrExternalEnum = new Uint32Array( [0,16,28,38,54,64,79] );

let slotMapIfcInternalOrExternalEnum = new Int32Array( [3,5,1,2,0,4] );

let encodedDataIfcInternalOrExternalEnum = (new TextEncoder()).encode( ".EXTERNAL_WATER..NOTDEFINED..EXTERNAL..EXTERNAL_EARTH..INTERNAL..EXTERNAL_FIRE." );
