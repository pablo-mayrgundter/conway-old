 ...
 */
export default abstract class IfcPoint extends IfcGeometricRepresentationItem 
{    
    public readonly specification: IfcPointSpecification = IfcPointSpecification.instance;
