...
{    
    ...
    public static readonly query = [ EntityTypesIfc.IFCELECTRICFLOWSTORAGEDEVICETYPE, EntityTypesIfc.IFCTANKTYPE ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCFLOWSTORAGEDEVICETYPE;
}
