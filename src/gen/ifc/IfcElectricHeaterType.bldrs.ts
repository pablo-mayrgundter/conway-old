...
import IfcElectricHeaterTypeEnum, { IfcElectricHeaterTypeEnumDeserializeStep } from "./IfcElectricHeaterTypeEnum.bldrs"
...
{    
    ...
    {
        return EntityTypesIfc.IFCELECTRICHEATERTYPE;
    }
    ...
    public get PredefinedType() : IfcElectricHeaterTypeEnum
    {
        if ( this.PredefinedType_ === void 0 )
        {
            ...
            let value = IfcElectricHeaterTypeEnumDeserializeStep( buffer, cursor, endCursor );
        ...
        return this.PredefinedType_ as IfcElectricHeaterTypeEnum;
    }
