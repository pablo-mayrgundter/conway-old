 ...
 */
export default abstract class IfcStyleModel extends IfcRepresentation 
{    
    public readonly specification: IfcStyleModelSpecification = IfcStyleModelSpecification.instance;
