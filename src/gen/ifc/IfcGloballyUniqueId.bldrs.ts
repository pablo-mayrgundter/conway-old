...
export const IfcGloballyUniqueIdSize = 4;

export function IfcGloballyUniqueIdSerializer( value?: IfcGloballyUniqueId, to: SmartBuffer, offset?: number ): void
{
    if ( value == undefined ) 
    {
        to.writeUInt32LE( 0 );
...
export function IfcGloballyUniqueIdDeserializer( value?: IfcGloballyUniqueId, from: SnapshotBuffer< SchemaSpecificationIFC >, offset?: number ): void
{
    ( () => { 
