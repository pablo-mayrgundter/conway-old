 ...
 */
export default abstract class IfcPreDefinedTextFont extends IfcPreDefinedItem 
{    
    public readonly specification: IfcPreDefinedTextFontSpecification = IfcPreDefinedTextFontSpecification.instance;
