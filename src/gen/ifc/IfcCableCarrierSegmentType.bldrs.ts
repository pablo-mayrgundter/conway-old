...
{    
    ...
    public static readonly query = [ EntityTypesIfc.IFCCABLECARRIERSEGMENTTYPE ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCCABLECARRIERSEGMENTTYPE;
}
