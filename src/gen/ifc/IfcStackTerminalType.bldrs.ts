...
{    
    ...
    public static readonly query = [ EntityTypesIfc.IFCSTACKTERMINALTYPE ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCSTACKTERMINALTYPE;
}
