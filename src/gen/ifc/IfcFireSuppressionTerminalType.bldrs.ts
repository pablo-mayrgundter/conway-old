...
{    
    ...
    public static readonly query = [ EntityTypesIfc.IFCFIRESUPPRESSIONTERMINALTYPE ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCFIRESUPPRESSIONTERMINALTYPE;
}
