...
{    
    ...
    public static readonly query = [ EntityTypesIfc.IFCSTRUCTURALPLANARACTION ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCSTRUCTURALPLANARACTION;
}
