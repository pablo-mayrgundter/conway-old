...
{    
    ...
    public get TensionFailureX() : number | null
    {
        ...
        {
            this.TensionFailureX_ = (() => { this.guaranteeVTable();
    ...
    public get TensionFailureY() : number | null
    {
        ...
        {
            this.TensionFailureY_ = (() => { this.guaranteeVTable();
    ...
    public get TensionFailureZ() : number | null
    {
        ...
        {
            this.TensionFailureZ_ = (() => { this.guaranteeVTable();
    ...
    public get CompressionFailureX() : number | null
    {
        ...
        {
            this.CompressionFailureX_ = (() => { this.guaranteeVTable();
    ...
    public get CompressionFailureY() : number | null
    {
        ...
        {
            this.CompressionFailureY_ = (() => { this.guaranteeVTable();
    ...
    public get CompressionFailureZ() : number | null
    {
        ...
        {
            this.CompressionFailureZ_ = (() => { this.guaranteeVTable();
