...
{    
    ...
    public get FlowDirection() : IfcFlowDirectionEnum | null
    {
        if ( this.FlowDirection_ === void 0 )
        {
            ...
            {
                throw new Error( "Couldn't read field FlowDirection due to too few fields in record" ); 
            }
            ...
            if ( value !== void 0 )
            {
                ...
                {
                    throw new Error( 'Value in STEP was incorrectly typed for field FlowDirection' );
                }

                this.FlowDirection_ = null;                
            }
            else
            {
                this.FlowDirection_ = value;
            }
        }
