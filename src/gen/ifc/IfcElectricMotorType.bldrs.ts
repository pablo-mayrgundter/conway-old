...
import IfcElectricMotorTypeEnum, { IfcElectricMotorTypeEnumDeserializeStep } from "./IfcElectricMotorTypeEnum.bldrs"
...
{    
    ...
    public get PredefinedType() : IfcElectricMotorTypeEnum
    {
        if ( this.PredefinedType_ === void 0 )
        {
            ...
            let value = IfcElectricMotorTypeEnumDeserializeStep( buffer, cursor, endCursor );
