...
export default class IfcTopologyRepresentation implements Component< SchemaSpecificationIFC > 
{
    ...
    public readonly __specification__: IfcTopologyRepresentationSpecification = IfcTopologyRepresentationSpecification.instance;
...
export class IfcTopologyRepresentationSpecification implements ComponentSpecification
{
    ...
    public readonly required: ReadonlyArray< string > = [ 'IfcShapeModel', 'IfcRepresentation' ];
