...
{    
    ...
    public get BottomFlangeWidth() : number
    {
        ...
        {
            this.BottomFlangeWidth_ = (() => { this.guaranteeVTable();
    ...
    public get BottomFlangeThickness() : number
    {
        ...
        {
            this.BottomFlangeThickness_ = (() => { this.guaranteeVTable();
    ...
    public get BottomFlangeFilletRadius() : number | null
    {
        ...
        {
            this.BottomFlangeFilletRadius_ = (() => { this.guaranteeVTable();
    ...
    public get BottomFlangeEdgeRadius() : number | null
    {
        ...
        {
            this.BottomFlangeEdgeRadius_ = (() => { this.guaranteeVTable();
    ...
    public get BottomFlangeSlope() : number | null
    {
        ...
        {
            this.BottomFlangeSlope_ = (() => { this.guaranteeVTable();
    ...
    public get TopFlangeEdgeRadius() : number | null
    {
        ...
        {
            this.TopFlangeEdgeRadius_ = (() => { this.guaranteeVTable();
    ...
    public get TopFlangeSlope() : number | null
    {
        ...
        {
            this.TopFlangeSlope_ = (() => { this.guaranteeVTable();
