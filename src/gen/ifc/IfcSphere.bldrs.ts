...
{    
    public readonly specification: IfcSphereSpecification = IfcSphereSpecification.instance;
...
export class IfcSphereSpecification implements ComponentSpecification
{
    ...
    public readonly required: ReadonlyArray< string > = [ 'IfcSphere', 'IfcCsgPrimitive3D', 'IfcGeometricRepresentationItem', 'IfcRepresentationItem' ];
