...
{    
    ...
    public get PredefinedType() : IfcCoilTypeEnum
    {
        if ( this.PredefinedType_ === void 0 )
        {
            ...
            let value = IfcCoilTypeEnumDeserializeStep( buffer, cursor, endCursor );
    ...
    public static readonly query = [ EntityTypesIfc.IFCCOILTYPE ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCCOILTYPE;
}
