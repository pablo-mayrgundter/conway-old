 ...
 */
export default abstract class IfcBuildingElementType extends IfcElementType 
{    
    public readonly specification: IfcBuildingElementTypeSpecification = IfcBuildingElementTypeSpecification.instance;
...
export class IfcBuildingElementTypeSpecification implements ComponentSpecification
{
    ...
    public static readonly instance: IfcBuildingElementTypeSpecification = new IfcBuildingElementTypeSpecification();
}
