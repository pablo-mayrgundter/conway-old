...
return value; })();
    ...
    public static readonly query = [ EntityTypesIfc.IFCRELREFERENCEDINSPATIALSTRUCTURE ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCRELREFERENCEDINSPATIALSTRUCTURE;
}
