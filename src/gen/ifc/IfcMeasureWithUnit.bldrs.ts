...
export class IfcMeasureWithUnitSpecification implements ComponentSpecification
{
    public readonly name: string = 'IfcMeasureWithUnit';

    public readonly required: ReadonlyArray< string > = [ 'IfcMeasureWithUnit' ];
    ...
    public static readonly instance: IfcMeasureWithUnitSpecification = new IfcMeasureWithUnitSpecification();
}
