...
{    
    ...
    public static readonly query = [ EntityTypesIfc.IFCOUTERBOUNDARYCURVE ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCOUTERBOUNDARYCURVE;
}
