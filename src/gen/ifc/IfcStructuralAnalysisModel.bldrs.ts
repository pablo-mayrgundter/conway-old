...
{    
    ...
    public get OrientationOf2DPlane() : IfcAxis2Placement3D | null
    {
        ...
        {
            this.OrientationOf2DPlane_ = (() => { this.guaranteeVTable();
    ...
    public get LoadedBy() : Array<IfcStructuralLoadGroup> | null
    {
        ...
        {
            this.LoadedBy_ = (() => { this.guaranteeVTable();
    ...
    public get HasResults() : Array<IfcStructuralResultGroup> | null
    {
        ...
        {
            this.HasResults_ = (() => { this.guaranteeVTable();
            ...
            for ( let address of stepExtractArray( buffer, cursor, endCursor ) )
            {
                value.push( (() => { 
                    ...
                    if ( value === void 0 || !( value instanceof IfcStructuralResultGroup ) )
                    {                
                        throw new Error( 'Value in STEP was incorrectly typed for field' );
                    };
