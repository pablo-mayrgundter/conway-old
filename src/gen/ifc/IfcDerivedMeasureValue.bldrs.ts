...
export default class IfcDerivedMeasureValue
{
    constructor( public readonly value: IfcDerivedMeasureValueVariant ) {}
}

export type IfcDerivedMeasureValueType = 'IfcVolumetricFlowRateMeasure'|'IfcTimeStamp'|'IfcThermalTransmittanceMeasure'|'IfcThermalResistanceMeasure'|'IfcThermalAdmittanceMeasure'|'IfcPressureMeasure'|'IfcPowerMeasure'|'IfcMassFlowRateMeasure'|'IfcMassDensityMeasure'|'IfcLinearVelocityMeasure'|'IfcKinematicViscosityMeasure'|'IfcIntegerCountRateMeasure'|'IfcHeatFluxDensityMeasure'|'IfcFrequencyMeasure'|'IfcEnergyMeasure'|'IfcElectricVoltageMeasure'|'IfcDynamicViscosityMeasure'|'IfcCompoundPlaneAngleMeasure'|'IfcAngularVelocityMeasure'|'IfcThermalConductivityMeasure'|'IfcMolecularWeightMeasure'|'IfcVaporPermeabilityMeasure'|'IfcMoistureDiffusivityMeasure'|'IfcIsothermalMoistureCapacityMeasure'|'IfcSpecificHeatCapacityMeasure'|'IfcMonetaryMeasure'|'IfcMagneticFluxDensityMeasure'|'IfcMagneticFluxMeasure'|'IfcLuminousFluxMeasure'|'IfcForceMeasure'|'IfcInductanceMeasure'|'IfcIlluminanceMeasure'|'IfcElectricResistanceMeasure'|'IfcElectricConductanceMeasure'|'IfcElectricChargeMeasure'|'IfcDoseEquivalentMeasure'|'IfcElectricCapacitanceMeasure'|'IfcAbsorbedDoseMeasure'|'IfcRadioActivityMeasure'|'IfcRotationalFrequencyMeasure'|'IfcTorqueMeasure'|'IfcAccelerationMeasure'|'IfcLinearForceMeasure'|'IfcLinearStiffnessMeasure'|'IfcModulusOfSubgradeReactionMeasure'|'IfcModulusOfElasticityMeasure'|'IfcMomentOfInertiaMeasure'|'IfcPlanarForceMeasure'|'IfcRotationalStiffnessMeasure'|'IfcShearModulusMeasure'|'IfcLinearMomentMeasure'|'IfcLuminousIntensityDistributionMeasure'|'IfcCurvatureMeasure'|'IfcMassPerLengthMeasure'|'IfcModulusOfLinearSubgradeReactionMeasure'|'IfcModulusOfRotationalSubgradeReactionMeasure'|'IfcRotationalMassMeasure'|'IfcSectionalAreaIntegralMeasure'|'IfcSectionModulusMeasure'|'IfcTemperatureGradientMeasure'|'IfcThermalExpansionCoefficientMeasure'|'IfcWarpingConstantMeasure'|'IfcWarpingMomentMeasure'|'IfcSoundPowerMeasure'|'IfcSoundPressureMeasure'|'IfcHeatingValueMeasure'|'IfcPHMeasure'|'IfcIonConcentrationMeasure';

export type IfcDerivedMeasureValueChoices = IfcVolumetricFlowRateMeasure|IfcTimeStamp|IfcThermalTransmittanceMeasure|IfcThermalResistanceMeasure|IfcThermalAdmittanceMeasure|IfcPressureMeasure|IfcPowerMeasure|IfcMassFlowRateMeasure|IfcMassDensityMeasure|IfcLinearVelocityMeasure|IfcKinematicViscosityMeasure|IfcIntegerCountRateMeasure|IfcHeatFluxDensityMeasure|IfcFrequencyMeasure|IfcEnergyMeasure|IfcElectricVoltageMeasure|IfcDynamicViscosityMeasure|IfcCompoundPlaneAngleMeasure|IfcAngularVelocityMeasure|IfcThermalConductivityMeasure|IfcMolecularWeightMeasure|IfcVaporPermeabilityMeasure|IfcMoistureDiffusivityMeasure|IfcIsothermalMoistureCapacityMeasure|IfcSpecificHeatCapacityMeasure|IfcMonetaryMeasure|IfcMagneticFluxDensityMeasure|IfcMagneticFluxMeasure|IfcLuminousFluxMeasure|IfcForceMeasure|IfcInductanceMeasure|IfcIlluminanceMeasure|IfcElectricResistanceMeasure|IfcElectricConductanceMeasure|IfcElectricChargeMeasure|IfcDoseEquivalentMeasure|IfcElectricCapacitanceMeasure|IfcAbsorbedDoseMeasure|IfcRadioActivityMeasure|IfcRotationalFrequencyMeasure|IfcTorqueMeasure|IfcAccelerationMeasure|IfcLinearForceMeasure|IfcLinearStiffnessMeasure|IfcModulusOfSubgradeReactionMeasure|IfcModulusOfElasticityMeasure|IfcMomentOfInertiaMeasure|IfcPlanarForceMeasure|IfcRotationalStiffnessMeasure|IfcShearModulusMeasure|IfcLinearMomentMeasure|IfcLuminousIntensityDistributionMeasure|IfcCurvatureMeasure|IfcMassPerLengthMeasure|IfcModulusOfLinearSubgradeReactionMeasure|IfcModulusOfRotationalSubgradeReactionMeasure|IfcRotationalMassMeasure|IfcSectionalAreaIntegralMeasure|IfcSectionModulusMeasure|IfcTemperatureGradientMeasure|IfcThermalExpansionCoefficientMeasure|IfcWarpingConstantMeasure|IfcWarpingMomentMeasure|IfcSoundPowerMeasure|IfcSoundPressureMeasure|IfcHeatingValueMeasure|IfcPHMeasure|IfcIonConcentrationMeasure;

export type IfcDerivedMeasureValueVariant = ({ type: 'IfcVolumetricFlowRateMeasure'; value: IfcVolumetricFlowRateMeasure }|{ type: 'IfcTimeStamp'; value: IfcTimeStamp }|{ type: 'IfcThermalTransmittanceMeasure'; value: IfcThermalTransmittanceMeasure }|{ type: 'IfcThermalResistanceMeasure'; value: IfcThermalResistanceMeasure }|{ type: 'IfcThermalAdmittanceMeasure'; value: IfcThermalAdmittanceMeasure }|{ type: 'IfcPressureMeasure'; value: IfcPressureMeasure }|{ type: 'IfcPowerMeasure'; value: IfcPowerMeasure }|{ type: 'IfcMassFlowRateMeasure'; value: IfcMassFlowRateMeasure }|{ type: 'IfcMassDensityMeasure'; value: IfcMassDensityMeasure }|{ type: 'IfcLinearVelocityMeasure'; value: IfcLinearVelocityMeasure }|{ type: 'IfcKinematicViscosityMeasure'; value: IfcKinematicViscosityMeasure }|{ type: 'IfcIntegerCountRateMeasure'; value: IfcIntegerCountRateMeasure }|{ type: 'IfcHeatFluxDensityMeasure'; value: IfcHeatFluxDensityMeasure }|{ type: 'IfcFrequencyMeasure'; value: IfcFrequencyMeasure }|{ type: 'IfcEnergyMeasure'; value: IfcEnergyMeasure }|{ type: 'IfcElectricVoltageMeasure'; value: IfcElectricVoltageMeasure }|{ type: 'IfcDynamicViscosityMeasure'; value: IfcDynamicViscosityMeasure }|{ type: 'IfcCompoundPlaneAngleMeasure'; value: IfcCompoundPlaneAngleMeasure }|{ type: 'IfcAngularVelocityMeasure'; value: IfcAngularVelocityMeasure }|{ type: 'IfcThermalConductivityMeasure'; value: IfcThermalConductivityMeasure }|{ type: 'IfcMolecularWeightMeasure'; value: IfcMolecularWeightMeasure }|{ type: 'IfcVaporPermeabilityMeasure'; value: IfcVaporPermeabilityMeasure }|{ type: 'IfcMoistureDiffusivityMeasure'; value: IfcMoistureDiffusivityMeasure }|{ type: 'IfcIsothermalMoistureCapacityMeasure'; value: IfcIsothermalMoistureCapacityMeasure }|{ type: 'IfcSpecificHeatCapacityMeasure'; value: IfcSpecificHeatCapacityMeasure }|{ type: 'IfcMonetaryMeasure'; value: IfcMonetaryMeasure }|{ type: 'IfcMagneticFluxDensityMeasure'; value: IfcMagneticFluxDensityMeasure }|{ type: 'IfcMagneticFluxMeasure'; value: IfcMagneticFluxMeasure }|{ type: 'IfcLuminousFluxMeasure'; value: IfcLuminousFluxMeasure }|{ type: 'IfcForceMeasure'; value: IfcForceMeasure }|{ type: 'IfcInductanceMeasure'; value: IfcInductanceMeasure }|{ type: 'IfcIlluminanceMeasure'; value: IfcIlluminanceMeasure }|{ type: 'IfcElectricResistanceMeasure'; value: IfcElectricResistanceMeasure }|{ type: 'IfcElectricConductanceMeasure'; value: IfcElectricConductanceMeasure }|{ type: 'IfcElectricChargeMeasure'; value: IfcElectricChargeMeasure }|{ type: 'IfcDoseEquivalentMeasure'; value: IfcDoseEquivalentMeasure }|{ type: 'IfcElectricCapacitanceMeasure'; value: IfcElectricCapacitanceMeasure }|{ type: 'IfcAbsorbedDoseMeasure'; value: IfcAbsorbedDoseMeasure }|{ type: 'IfcRadioActivityMeasure'; value: IfcRadioActivityMeasure }|{ type: 'IfcRotationalFrequencyMeasure'; value: IfcRotationalFrequencyMeasure }|{ type: 'IfcTorqueMeasure'; value: IfcTorqueMeasure }|{ type: 'IfcAccelerationMeasure'; value: IfcAccelerationMeasure }|{ type: 'IfcLinearForceMeasure'; value: IfcLinearForceMeasure }|{ type: 'IfcLinearStiffnessMeasure'; value: IfcLinearStiffnessMeasure }|{ type: 'IfcModulusOfSubgradeReactionMeasure'; value: IfcModulusOfSubgradeReactionMeasure }|{ type: 'IfcModulusOfElasticityMeasure'; value: IfcModulusOfElasticityMeasure }|{ type: 'IfcMomentOfInertiaMeasure'; value: IfcMomentOfInertiaMeasure }|{ type: 'IfcPlanarForceMeasure'; value: IfcPlanarForceMeasure }|{ type: 'IfcRotationalStiffnessMeasure'; value: IfcRotationalStiffnessMeasure }|{ type: 'IfcShearModulusMeasure'; value: IfcShearModulusMeasure }|{ type: 'IfcLinearMomentMeasure'; value: IfcLinearMomentMeasure }|{ type: 'IfcLuminousIntensityDistributionMeasure'; value: IfcLuminousIntensityDistributionMeasure }|{ type: 'IfcCurvatureMeasure'; value: IfcCurvatureMeasure }|{ type: 'IfcMassPerLengthMeasure'; value: IfcMassPerLengthMeasure }|{ type: 'IfcModulusOfLinearSubgradeReactionMeasure'; value: IfcModulusOfLinearSubgradeReactionMeasure }|{ type: 'IfcModulusOfRotationalSubgradeReactionMeasure'; value: IfcModulusOfRotationalSubgradeReactionMeasure }|{ type: 'IfcRotationalMassMeasure'; value: IfcRotationalMassMeasure }|{ type: 'IfcSectionalAreaIntegralMeasure'; value: IfcSectionalAreaIntegralMeasure }|{ type: 'IfcSectionModulusMeasure'; value: IfcSectionModulusMeasure }|{ type: 'IfcTemperatureGradientMeasure'; value: IfcTemperatureGradientMeasure }|{ type: 'IfcThermalExpansionCoefficientMeasure'; value: IfcThermalExpansionCoefficientMeasure }|{ type: 'IfcWarpingConstantMeasure'; value: IfcWarpingConstantMeasure }|{ type: 'IfcWarpingMomentMeasure'; value: IfcWarpingMomentMeasure }|{ type: 'IfcSoundPowerMeasure'; value: IfcSoundPowerMeasure }|{ type: 'IfcSoundPressureMeasure'; value: IfcSoundPressureMeasure }|{ type: 'IfcHeatingValueMeasure'; value: IfcHeatingValueMeasure }|{ type: 'IfcPHMeasure'; value: IfcPHMeasure }|{ type: 'IfcIonConcentrationMeasure'; value: IfcIonConcentrationMeasure }) & { type: IfcDerivedMeasureValueType; value: IfcDerivedMeasureValueChoices };

export function IfcDerivedMeasureValueSerializer( value?: IfcDerivedMeasureValue, to: SmartBuffer, offset?: number )
{
    switch
