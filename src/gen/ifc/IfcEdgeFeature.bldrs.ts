...
export abstract class IfcEdgeFeature extends IfcFeatureElementSubtraction 
{    
    ...
    private FeatureLength_? : number | null;

    public get FeatureLength() : number | null
    {
        ...
        return this.FeatureLength_ as number | null;
    }
