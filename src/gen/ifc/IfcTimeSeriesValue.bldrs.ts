 ...
 */
export default  class IfcTimeSeriesValue extends EntityBase< SchemaSpecificationIFC > 
{    
    public readonly specification: IfcTimeSeriesValueSpecification = IfcTimeSeriesValueSpecification.instance;
...
export class IfcTimeSeriesValueSpecification implements ComponentSpecification
{
    ...
    public readonly required: ReadonlyArray< string > = [ 'IfcTimeSeriesValue' ];
