 ...
 */
export default class IfcTimeSeriesValue implements Component< SchemaSpecificationIFC > 
{
    public readonly __type__ = 'IfcTimeSeriesValue';

    public readonly __version__: number = 0;

    public readonly __specification__: IfcTimeSeriesValueSpecification = IfcTimeSeriesValueSpecification.instance;
...
export class IfcTimeSeriesValueSpecification implements ComponentSpecification
{
    public readonly name: string = 'IfcTimeSeriesValue';
    ...
    public static readonly instance: IfcTimeSeriesValueSpecification = new IfcTimeSeriesValueSpecification();
}
