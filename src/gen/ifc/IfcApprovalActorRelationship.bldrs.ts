...
export  class IfcApprovalActorRelationship extends StepEntityBase< EntityTypesIfc > 
{    
    ...
    public get Actor() : IfcOrganization|IfcPerson|IfcPersonAndOrganization
    {
        ...
        {
            this.Actor_ = (() => { this.guaranteeVTable();
...
( () => { 
    ...
    public get Approval() : IfcApproval
    {
        ...
        {
            this.Approval_ = (() => { this.guaranteeVTable();
    ...
    public get Role() : IfcActorRole
    {
        ...
        {
            this.Role_ = (() => { this.guaranteeVTable();
