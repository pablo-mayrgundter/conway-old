...
{    
    ...
    public get Eastings() : number
    {
        ...
        {
            this.Eastings_ = (() => { this.guaranteeVTable();
    ...
    public get Northings() : number
    {
        ...
        {
            this.Northings_ = (() => { this.guaranteeVTable();
    ...
    public get OrthogonalHeight() : number
    {
        ...
        {
            this.OrthogonalHeight_ = (() => { this.guaranteeVTable();
    ...
    public get XAxisAbscissa() : number | null
    {
        ...
        {
            this.XAxisAbscissa_ = (() => { this.guaranteeVTable();
    ...
    public get XAxisOrdinate() : number | null
    {
        ...
        {
            this.XAxisOrdinate_ = (() => { this.guaranteeVTable();
    ...
    public get Scale() : number | null
    {
        ...
        {
            this.Scale_ = (() => { this.guaranteeVTable();
