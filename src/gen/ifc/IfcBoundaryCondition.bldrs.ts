 ...
 */
export default abstract class IfcBoundaryCondition extends EntityBase< SchemaSpecificationIFC > 
{    
    public readonly specification: IfcBoundaryConditionSpecification = IfcBoundaryConditionSpecification.instance;
