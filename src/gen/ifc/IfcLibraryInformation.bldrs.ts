...
export  class IfcLibraryInformation extends StepEntityBase< EntityTypesIfc > 
{    
    ...
    public get Publisher() : IfcOrganization | null
    {
        ...
        {
            this.Publisher_ = (() => { this.guaranteeVTable();
    ...
    public get VersionDate() : IfcCalendarDate | null
    {
        ...
        {
            this.VersionDate_ = (() => { this.guaranteeVTable();
    ...
    public get LibraryReference() : Array<IfcLibraryReference> | null
    {
        ...
        {
            this.LibraryReference_ = (() => { this.guaranteeVTable();
            ...
            let value : Array<IfcLibraryReference> = [];
            ...
            for ( let address of stepExtractArray( buffer, cursor, endCursor ) )
            {
                value.push( (() => { 
                    ...
                    if ( !( value instanceof IfcLibraryReference ) )
                    {                
                        throw new Error( 'Value in STEP was incorrectly typed for field' );
                    };
