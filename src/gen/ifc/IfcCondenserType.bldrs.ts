...
{    
    ...
    public get PredefinedType() : IfcCondenserTypeEnum
    {
        if ( this.PredefinedType_ === void 0 )
        {
            ...
            let value = IfcCondenserTypeEnumDeserializeStep( buffer, cursor, endCursor );
    ...
    public static readonly query = [ EntityTypesIfc.IFCCONDENSERTYPE ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCCONDENSERTYPE;
}
