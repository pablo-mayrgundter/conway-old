...
export  class IfcDocumentInformationRelationship extends StepEntityBase< EntityTypesIfc > 
{    
    ...
    public get RelatedDocuments() : Array<IfcDocumentInformation>
    {
        ...
        {
            this.RelatedDocuments_ = (() => { this.guaranteeVTable();
    ...
    public get RelationshipType() : string | null
    {
        ...
        {
            this.RelationshipType_ = (() => { this.guaranteeVTable();
