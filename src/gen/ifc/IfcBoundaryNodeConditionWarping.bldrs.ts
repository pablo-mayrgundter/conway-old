...
{    
    ...
    private WarpingStiffness_? : number | null;

    public get WarpingStiffness() : number | null
    {
        if ( this.WarpingStiffness_ === void 0 )
        {
            this.WarpingStiffness_ = (() => { this.guaranteeVTable();
        ...
        return this.WarpingStiffness_ as number | null;
    }
