...
{    
    ...
    public get WarpingStiffness() : IfcWarpingMomentMeasure | null
    {
        if ( this.WarpingStiffness_ === void 0 )
        {
            ...
            {
                throw new Error( "Couldn't read field WarpingStiffness due to too few fields in record" ); 
            }
            ...
            if ( value !== void 0 )
            {
                ...
                {
                    throw new Error( 'Value in STEP was incorrectly typed for field WarpingStiffness' );
                }

                this.WarpingStiffness_ = null;                
            }
            else
            {
                this.WarpingStiffness_ = value;
            }
        }

        return this.WarpingStiffness_ as IfcWarpingMomentMeasure | null;
    }
