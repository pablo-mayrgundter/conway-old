...
{    
    public readonly specification: IfcMechanicalFastenerTypeSpecification = IfcMechanicalFastenerTypeSpecification.instance;
...
export class IfcMechanicalFastenerTypeSpecification implements ComponentSpecification
{
    ...
    public readonly required: ReadonlyArray< string > = [ 'IfcMechanicalFastenerType', 'IfcFastenerType', 'IfcElementComponentType', 'IfcElementType', 'IfcTypeProduct', 'IfcTypeObject', 'IfcObjectDefinition', 'IfcRoot' ];
