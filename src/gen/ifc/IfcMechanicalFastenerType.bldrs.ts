...
{    
    ...
    public get PredefinedType() : IfcMechanicalFastenerTypeEnum
    {
        if ( this.PredefinedType_ === void 0 )
        {
            ...
            let value = IfcMechanicalFastenerTypeEnumDeserializeStep( buffer, cursor, endCursor );
    ...
    public get NominalLength() : number | null
    {
        ...
        {
            this.NominalLength_ = (() => { this.guaranteeVTable();
    ...
    public static readonly query = [ EntityTypesIfc.IFCMECHANICALFASTENERTYPE ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCMECHANICALFASTENERTYPE;
}
