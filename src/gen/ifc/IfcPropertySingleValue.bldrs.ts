 ...
 */
export default class IfcPropertySingleValue implements Component< SchemaSpecificationIFC > 
{
    public readonly __type__ = 'IfcPropertySingleValue';

    public readonly __version__: number = 0;

    public readonly __specification__: IfcPropertySingleValueSpecification = IfcPropertySingleValueSpecification.instance;
