...
export class IfcPropertySingleValueSpecification implements ComponentSpecification
{
    public readonly name: string = 'IfcPropertySingleValue';

    public readonly required: ReadonlyArray< string > = [ 'IfcPropertySingleValue', 'IfcSimpleProperty', 'IfcProperty' ];
    ...
    public static readonly instance: IfcPropertySingleValueSpecification = new IfcPropertySingleValueSpecification();
}
