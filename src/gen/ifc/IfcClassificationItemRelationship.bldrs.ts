...
export  class IfcClassificationItemRelationship extends StepEntityBase< EntityTypesIfc > 
{    
    ...
    public get RelatingItem() : IfcClassificationItem
    {
        ...
        {
            this.RelatingItem_ = (() => { this.guaranteeVTable();
            ...
            if ( !( value instanceof IfcClassificationItem ) )
            {                
    ...
    public get RelatedItems() : Array<IfcClassificationItem>
    {
        ...
        {
            this.RelatedItems_ = (() => { this.guaranteeVTable();
            ...
            let value : Array<IfcClassificationItem> = [];
