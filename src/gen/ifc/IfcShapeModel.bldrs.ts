 ...
 */
export default abstract class IfcShapeModel extends IfcRepresentation 
{    
    public readonly specification: IfcShapeModelSpecification = IfcShapeModelSpecification.instance;
