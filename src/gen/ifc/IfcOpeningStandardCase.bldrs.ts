...
{    
    ...
    public static readonly query = [ EntityTypesIfc.IFCOPENINGSTANDARDCASE ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCOPENINGSTANDARDCASE;
}
