...
{    
    ...
    public static readonly query = [ EntityTypesIfc.IFCMEMBERSTANDARDCASE ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCMEMBERSTANDARDCASE;
}
