...
import IfcMotorConnectionTypeEnum, { IfcMotorConnectionTypeEnumDeserializeStep } from "./IfcMotorConnectionTypeEnum.bldrs"
...
{    
    ...
    public get PredefinedType() : IfcMotorConnectionTypeEnum
    {
        if ( this.PredefinedType_ === void 0 )
        {
            ...
            let value = IfcMotorConnectionTypeEnumDeserializeStep( buffer, cursor, endCursor );
