...
{    
    ...
    public static readonly query = [ EntityTypesIfc.IFCMOTORCONNECTIONTYPE ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCMOTORCONNECTIONTYPE;
}
