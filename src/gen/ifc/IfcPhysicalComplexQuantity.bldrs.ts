...
{    
    ...
    public get HasQuantities() : Array<IfcPhysicalQuantity>
    {
        ...
        {
            this.HasQuantities_ = (() => { this.guaranteeVTable();
            ...
            for ( let address of stepExtractArray( buffer, cursor, endCursor ) )
            {
                value.push( (() => { 
                    ...
                    if ( value === void 0 || !( value instanceof IfcPhysicalQuantity ) )
                    {                
    ...
    public get Discrimination() : IfcLabel
    {
        ...
        {
            this.Discrimination_ = (() => { this.guaranteeVTable();
    ...
    public get Quality() : IfcLabel | null
    {
        ...
        {
            this.Quality_ = (() => { this.guaranteeVTable();
