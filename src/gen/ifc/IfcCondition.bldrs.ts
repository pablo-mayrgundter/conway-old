...
export default class IfcCondition implements Component< SchemaSpecificationIFC > 
{
    ...
    public readonly __specification__: IfcConditionSpecification = IfcConditionSpecification.instance;
...
export class IfcConditionSpecification implements ComponentSpecification
{
    ...
    public static readonly instance: IfcConditionSpecification = new IfcConditionSpecification();
}
