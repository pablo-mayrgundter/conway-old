...
export default class IfcFurnishingElementType implements Component< SchemaSpecificationIFC > 
{
    ...
    public readonly __specification__: IfcFurnishingElementTypeSpecification = IfcFurnishingElementTypeSpecification.instance;
...
export class IfcFurnishingElementTypeSpecification implements ComponentSpecification
{
    ...
    public static readonly instance: IfcFurnishingElementTypeSpecification = new IfcFurnishingElementTypeSpecification();
}
