...
{    
    ...
    public get RelatingMonetaryUnit() : IfcMonetaryUnit
    {
        ...
        {
            this.RelatingMonetaryUnit_ = (() => { this.guaranteeVTable();
    ...
    public get RelatedMonetaryUnit() : IfcMonetaryUnit
    {
        ...
        {
            this.RelatedMonetaryUnit_ = (() => { this.guaranteeVTable();
    ...
    public get ExchangeRate() : number
    {
        ...
        {
            this.ExchangeRate_ = (() => { this.guaranteeVTable();
    ...
    public get RateDateTime() : string | null
    {
        ...
        {
            this.RateDateTime_ = (() => { this.guaranteeVTable();
    ...
    public get RateSource() : IfcLibraryInformation | null
    {
        ...
        {
            this.RateSource_ = (() => { this.guaranteeVTable();
