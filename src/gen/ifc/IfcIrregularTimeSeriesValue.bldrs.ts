 ...
 */
export default  class IfcIrregularTimeSeriesValue extends EntityBase< SchemaSpecificationIFC > 
{    
    public readonly specification: IfcIrregularTimeSeriesValueSpecification = IfcIrregularTimeSeriesValueSpecification.instance;
...
export class IfcIrregularTimeSeriesValueSpecification implements ComponentSpecification
{
    ...
    public readonly required: ReadonlyArray< string > = [ 'IfcIrregularTimeSeriesValue' ];
