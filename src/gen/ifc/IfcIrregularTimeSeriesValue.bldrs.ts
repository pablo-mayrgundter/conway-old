...
export class IfcIrregularTimeSeriesValueSpecification implements ComponentSpecification
{
    ...
    public static readonly instance: IfcIrregularTimeSeriesValueSpecification = new IfcIrregularTimeSeriesValueSpecification();
}
