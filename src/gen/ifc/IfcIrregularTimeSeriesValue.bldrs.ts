...
return value; })();
    ...
    public static readonly query = [ EntityTypesIfc.IFCIRREGULARTIMESERIESVALUE ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCIRREGULARTIMESERIESVALUE;
}
