...
{    
    ...
    public static readonly query = [ EntityTypesIfc.IFCPLANARFORCEMEASURE ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCPLANARFORCEMEASURE;
}
