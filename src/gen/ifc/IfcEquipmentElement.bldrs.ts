...
{    
    public readonly specification: IfcEquipmentElementSpecification = IfcEquipmentElementSpecification.instance;
...
export class IfcEquipmentElementSpecification implements ComponentSpecification
{
    ...
    public readonly required: ReadonlyArray< string > = [ 'IfcEquipmentElement', 'IfcElement', 'IfcProduct', 'IfcObject', 'IfcObjectDefinition', 'IfcRoot' ];
