...
return value; })();
    ...
    public static readonly query = [ EntityTypesIfc.IFCPROPERTYENUMERATION ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCPROPERTYENUMERATION;
}
