 ...
 */
export default  class IfcPropertyEnumeration extends EntityBase< SchemaSpecificationIFC > 
{    
    public readonly specification: IfcPropertyEnumerationSpecification = IfcPropertyEnumerationSpecification.instance;
...
export class IfcPropertyEnumerationSpecification implements ComponentSpecification
{
    public readonly name: string = 'IfcPropertyEnumeration';

    public readonly required: ReadonlyArray< string > = [ 'IfcPropertyEnumeration' ];
    ...
    public static readonly instance: IfcPropertyEnumerationSpecification = new IfcPropertyEnumerationSpecification();
}
