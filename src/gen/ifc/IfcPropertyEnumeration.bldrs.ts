 ...
 */
export default class IfcPropertyEnumeration implements Component< SchemaSpecificationIFC > 
{
    public readonly __type__ = 'IfcPropertyEnumeration';

    public readonly __version__: number = 0;

    public readonly __specification__: IfcPropertyEnumerationSpecification = IfcPropertyEnumerationSpecification.instance;
