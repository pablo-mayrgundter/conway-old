...
let gMapIfcControllerTypeEnum = new Int32Array( [63] );

let prefixSumAddressIfcControllerTypeEnum = new Uint32Array( [0,13,27,39,54,67,81,91] );

let slotMapIfcControllerTypeEnum = new Int32Array( [4,1,6,3,5,2,0] );

let encodedDataIfcControllerTypeEnum = (new TextEncoder()).encode( ".TWOPOSITION..PROGRAMMABLE..NOTDEFINED..MULTIPOSITION..USERDEFINED..PROPORTIONAL..FLOATING." );
