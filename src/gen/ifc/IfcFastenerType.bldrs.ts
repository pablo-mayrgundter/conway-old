 ...
 */
export default  class IfcFastenerType extends IfcElementComponentType 
{    
    public readonly specification: IfcFastenerTypeSpecification = IfcFastenerTypeSpecification.instance;
