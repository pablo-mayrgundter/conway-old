...
{    
    ...
    public get SpineCurve() : IfcCompositeCurve
    {
        ...
        {
            this.SpineCurve_ = (() => { this.guaranteeVTable();
            ...
            if ( value === void 0 || !( value instanceof IfcCompositeCurve ) )
            {                
    ...
    public get CrossSections() : Array<IfcProfileDef>
    {
        ...
        {
            this.CrossSections_ = (() => { this.guaranteeVTable();
    ...
    public get CrossSectionPositions() : Array<IfcAxis2Placement3D>
    {
        ...
        {
            this.CrossSectionPositions_ = (() => { this.guaranteeVTable();
