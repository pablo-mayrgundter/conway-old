...
{    
    public readonly specification: IfcRelSchedulesCostItemsSpecification = IfcRelSchedulesCostItemsSpecification.instance;
...
export class IfcRelSchedulesCostItemsSpecification implements ComponentSpecification
{
    ...
    public readonly required: ReadonlyArray< string > = [ 'IfcRelSchedulesCostItems', 'IfcRelAssignsToControl', 'IfcRelAssigns', 'IfcRelationship', 'IfcRoot' ];
