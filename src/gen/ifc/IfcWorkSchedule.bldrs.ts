...
{    
    public readonly specification: IfcWorkScheduleSpecification = IfcWorkScheduleSpecification.instance;
...
export class IfcWorkScheduleSpecification implements ComponentSpecification
{
    ...
    public readonly required: ReadonlyArray< string > = [ 'IfcWorkSchedule', 'IfcWorkControl', 'IfcControl', 'IfcObject', 'IfcObjectDefinition', 'IfcRoot' ];
