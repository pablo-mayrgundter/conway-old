...
{    
    ...
    public get UrlReference() : IfcIdentifier
    {
        if ( this.UrlReference_ === void 0 )
        {
            ...
            {
                throw new Error( "Couldn't read field UrlReference due to too few fields in record" ); 
            }
            ...
            if ( value === void 0 )
            {                
                throw new Error( 'Value in STEP was incorrectly typed for field UrlReference' );
            };

            this.UrlReference_ = value;
        }
