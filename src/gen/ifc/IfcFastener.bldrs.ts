 ...
 */
export default  class IfcFastener extends IfcElementComponent 
{    
    public readonly specification: IfcFastenerSpecification = IfcFastenerSpecification.instance;
...
export class IfcFastenerSpecification implements ComponentSpecification
{
    ...
    public static readonly instance: IfcFastenerSpecification = new IfcFastenerSpecification();
}
