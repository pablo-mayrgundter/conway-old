...
export default class IfcFurnishingElement implements Component< SchemaSpecificationIFC > 
{
    ...
    public readonly __specification__: IfcFurnishingElementSpecification = IfcFurnishingElementSpecification.instance;
...
export class IfcFurnishingElementSpecification implements ComponentSpecification
{
    ...
    public static readonly instance: IfcFurnishingElementSpecification = new IfcFurnishingElementSpecification();
}
