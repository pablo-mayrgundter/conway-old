...
{    
    ...
    public static readonly query = [ EntityTypesIfc.IFCCABLECARRIERFITTING ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCCABLECARRIERFITTING;
}
