...
{    
    ...
    public get Usage() : IfcResourceTime | null
    {
        ...
        {
            this.Usage_ = (() => { this.guaranteeVTable();
            ...
            if ( !( value instanceof IfcResourceTime ) )
            {
    ...
    public get BaseCosts() : Array<IfcAppliedValue> | null
    {
        ...
        {
            this.BaseCosts_ = (() => { this.guaranteeVTable();
...
return value; })();
    ...
    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCCONSTRUCTIONRESOURCE;
}
