...
import { IfcResourceConsumptionEnum, IfcResourceConsumptionEnumDeserializeStep } from "./index"
...
{    
    ...
    public get ResourceIdentifier() : string | null
    {
        ...
        {
            this.ResourceIdentifier_ = (() => { this.guaranteeVTable();
    ...
    public get ResourceGroup() : string | null
    {
        ...
        {
            this.ResourceGroup_ = (() => { this.guaranteeVTable();
    ...
    public get ResourceConsumption() : IfcResourceConsumptionEnum | null
    {
        ...
        {
            this.ResourceConsumption_ = (() => { this.guaranteeVTable();
    ...
    public get BaseQuantity() : IfcMeasureWithUnit | null
    {
        ...
        {
            this.BaseQuantity_ = (() => { this.guaranteeVTable();
