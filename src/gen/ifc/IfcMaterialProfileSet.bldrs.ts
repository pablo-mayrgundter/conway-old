...
{    
    ...
    public get MaterialProfiles() : Array<IfcMaterialProfile>
    {
        ...
        {
            this.MaterialProfiles_ = (() => { this.guaranteeVTable();
...
return value; })();
    ...
    public get CompositeProfile() : IfcCompositeProfileDef | null
    {
        ...
        {
            this.CompositeProfile_ = (() => { this.guaranteeVTable();
            ...
            if ( !( value instanceof IfcCompositeProfileDef ) )
            {
                if ( stepExtractOptional( buffer, cursor, endCursor ) !== null )
                {
                    throw new Error( 'Value in STEP was incorrectly typed for field' );
    ...
    public static readonly query = [ EntityTypesIfc.IFCMATERIALPROFILESET ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCMATERIALPROFILESET;
}
