...
import IfcDuctSegmentTypeEnum, { IfcDuctSegmentTypeEnumDeserializeStep } from "./IfcDuctSegmentTypeEnum.bldrs"
...
{    
    ...
    public get PredefinedType() : IfcDuctSegmentTypeEnum
    {
        if ( this.PredefinedType_ === void 0 )
        {
            ...
            let value = IfcDuctSegmentTypeEnumDeserializeStep( buffer, cursor, endCursor );
