...
export default  class IfcDerivedUnitElement extends StepEntityBase< EntityTypesIfc > 
{    
    ...
    public get Exponent() : number
    {
        if ( this.Exponent_ === void 0 )
        {
            ...
            {
                throw new Error( "Couldn't read field Exponent due to too few fields in record" ); 
            }
            ...
            if ( value === void 0 )
            {                
                throw new Error( 'Value in STEP was incorrectly typed for field Exponent' );
            };

            this.Exponent_ = value;
        }
