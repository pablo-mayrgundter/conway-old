...
{    
    ...
    public get EndTime() : IfcCalendarDate|IfcLocalTime|IfcDateAndTime
    {
        ...
        {
            this.EndTime_ = (() => { this.guaranteeVTable();
    ...
    public get TimeSeriesDataType() : IfcTimeSeriesDataTypeEnum
    {
        ...
        {
            this.TimeSeriesDataType_ = (() => { this.guaranteeVTable();
    ...
    public get DataOrigin() : IfcDataOriginEnum
    {
        ...
        {
            this.DataOrigin_ = (() => { this.guaranteeVTable();
    ...
    public get UserDefinedDataOrigin() : string | null
    {
        ...
        {
            this.UserDefinedDataOrigin_ = (() => { this.guaranteeVTable();
