...
{    
    ...
    public static readonly query = [ EntityTypesIfc.IFCMATERIALPROFILE, EntityTypesIfc.IFCMATERIALPROFILEWITHOFFSETS ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCMATERIALPROFILE;
}
