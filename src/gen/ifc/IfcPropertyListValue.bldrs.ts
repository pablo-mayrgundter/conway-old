 ...
 */
export default class IfcPropertyListValue implements Component< SchemaSpecificationIFC > 
{
    public readonly __type__ = 'IfcPropertyListValue';

    public readonly __version__: number = 0;

    public readonly __specification__: IfcPropertyListValueSpecification = IfcPropertyListValueSpecification.instance;
...
export class IfcPropertyListValueSpecification implements ComponentSpecification
{
    public readonly name: string = 'IfcPropertyListValue';
    ...
    public static readonly instance: IfcPropertyListValueSpecification = new IfcPropertyListValueSpecification();
}
