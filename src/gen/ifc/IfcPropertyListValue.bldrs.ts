 ...
 */
export default  class IfcPropertyListValue extends IfcSimpleProperty 
{    
    public readonly specification: IfcPropertyListValueSpecification = IfcPropertyListValueSpecification.instance;
...
export class IfcPropertyListValueSpecification implements ComponentSpecification
{
    ...
    public readonly required: ReadonlyArray< string > = [ 'IfcPropertyListValue', 'IfcSimpleProperty', 'IfcProperty' ];
