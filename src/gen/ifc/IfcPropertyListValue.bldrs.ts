...
return value; })();
    ...
    public static readonly query = [ EntityTypesIfc.IFCPROPERTYLISTVALUE ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCPROPERTYLISTVALUE;
}
