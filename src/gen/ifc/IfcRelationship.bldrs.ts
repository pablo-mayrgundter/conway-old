 ...
 */
export default abstract class IfcRelationship extends IfcRoot 
{    
    public readonly specification: IfcRelationshipSpecification = IfcRelationshipSpecification.instance;
...
export class IfcRelationshipSpecification implements ComponentSpecification
{
    ...
    public static readonly instance: IfcRelationshipSpecification = new IfcRelationshipSpecification();
}
