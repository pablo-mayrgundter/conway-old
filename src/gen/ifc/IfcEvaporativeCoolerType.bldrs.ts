...
{    
    ...
    public static readonly query = [ EntityTypesIfc.IFCEVAPORATIVECOOLERTYPE ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCEVAPORATIVECOOLERTYPE;
}
