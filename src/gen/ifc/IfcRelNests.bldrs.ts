...
{    
    public readonly specification: IfcRelNestsSpecification = IfcRelNestsSpecification.instance;
...
export class IfcRelNestsSpecification implements ComponentSpecification
{
    ...
    public readonly required: ReadonlyArray< string > = [ 'IfcRelNests', 'IfcRelDecomposes', 'IfcRelationship', 'IfcRoot' ];
