...
export default class IfcFlowControllerType implements Component< SchemaSpecificationIFC > 
{
    ...
    public readonly __specification__: IfcFlowControllerTypeSpecification = IfcFlowControllerTypeSpecification.instance;
...
export class IfcFlowControllerTypeSpecification implements ComponentSpecification
{
    ...
    public static readonly instance: IfcFlowControllerTypeSpecification = new IfcFlowControllerTypeSpecification();
}
