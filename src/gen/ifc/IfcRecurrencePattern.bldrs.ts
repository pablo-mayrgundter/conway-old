...
{    
    ...
    public get RecurrenceType() : IfcRecurrenceTypeEnum
    {
        ...
        {
            this.RecurrenceType_ = (() => { this.guaranteeVTable();
...
return value; })();
    ...
    public get WeekdayComponent() : Array< number > | null
    {
        ...
        {
            this.WeekdayComponent_ = (() => { this.guaranteeVTable();
...
return value; })();
    ...
    public get Interval() : number | null
    {
        ...
        {
            this.Interval_ = (() => { this.guaranteeVTable();
    ...
    public get Occurrences() : number | null
    {
        ...
        {
            this.Occurrences_ = (() => { this.guaranteeVTable();
    ...
    public get TimePeriods() : Array<IfcTimePeriod> | null
    {
        ...
        {
            this.TimePeriods_ = (() => { this.guaranteeVTable();
