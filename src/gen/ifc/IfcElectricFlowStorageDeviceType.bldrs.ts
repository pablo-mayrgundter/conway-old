...
{    
    ...
    public static readonly query = [ EntityTypesIfc.IFCELECTRICFLOWSTORAGEDEVICETYPE ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCELECTRICFLOWSTORAGEDEVICETYPE;
}
