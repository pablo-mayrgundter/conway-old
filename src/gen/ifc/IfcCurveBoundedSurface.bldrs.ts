...
{    
    ...
    public get Boundaries() : Array<IfcBoundaryCurve>
    {
        ...
        {
            this.Boundaries_ = (() => { this.guaranteeVTable();
...
return value; })();
    ...
    public get ImplicitOuter() : boolean
    {
        ...
        {
            this.ImplicitOuter_ = (() => { this.guaranteeVTable();
    ...
    public static readonly query = [ EntityTypesIfc.IFCCURVEBOUNDEDSURFACE ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCCURVEBOUNDEDSURFACE;
}
