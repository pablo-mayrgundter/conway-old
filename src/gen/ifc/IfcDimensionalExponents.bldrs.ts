...
{    
    ...
    public get LengthExponent() : number
    {
        ...
        {
            this.LengthExponent_ = (() => { this.guaranteeVTable();
    ...
    public get MassExponent() : number
    {
        ...
        {
            this.MassExponent_ = (() => { this.guaranteeVTable();
    ...
    public get TimeExponent() : number
    {
        ...
        {
            this.TimeExponent_ = (() => { this.guaranteeVTable();
    ...
    public get ElectricCurrentExponent() : number
    {
        ...
        {
            this.ElectricCurrentExponent_ = (() => { this.guaranteeVTable();
    ...
    public get ThermodynamicTemperatureExponent() : number
    {
        ...
        {
            this.ThermodynamicTemperatureExponent_ = (() => { this.guaranteeVTable();
    ...
    public get AmountOfSubstanceExponent() : number
    {
        ...
        {
            this.AmountOfSubstanceExponent_ = (() => { this.guaranteeVTable();
    ...
    public get LuminousIntensityExponent() : number
    {
        ...
        {
            this.LuminousIntensityExponent_ = (() => { this.guaranteeVTable();
