...
return value; })();
    ...
    public static readonly query = [ EntityTypesIfc.IFCRELDEFINESBYPROPERTIES ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCRELDEFINESBYPROPERTIES;
}
