...
{    
    ...
    public get FillStyles() : Array<IfcFillAreaStyleHatching|IfcFillAreaStyleTiles|IfcColourSpecification|IfcPreDefinedColour|IfcExternallyDefinedHatchStyle>
    {
            ...
            for ( let address of stepExtractArray( buffer, cursor, endCursor ) )
            {
                value.push( (() => { 
                    ...
                    let value = ( () => { 
                                    ...
                                    if ( !( value instanceof IfcFillAreaStyleHatching ) )
                                    {                
                                        return (void 0);
                                    };
        ...
        ( () => { 
                                    ...
                                    if ( !( value instanceof IfcFillAreaStyleTiles ) )
                                    {                
                                        return (void 0);
                                    };
        ...
        ( () => { 
                                    ...
                                    if ( !( value instanceof IfcColourSpecification ) )
                                    {                
                                        return (void 0);
                                    };
        ...
        ( () => { 
                                    ...
                                    if ( !( value instanceof IfcPreDefinedColour ) )
                                    {                
                                        return (void 0);
                                    };
        ...
        ( () => { 
                                    ...
                                    if ( !( value instanceof IfcExternallyDefinedHatchStyle ) )
                                    {                
                                        return (void 0);
                                    };
