...
let gMapIfcRoleEnum = new Int32Array( [32,1,81,8,34,483] );

let prefixSumAddressIfcRoleEnum = new Uint32Array( [0,15,26,42,63,76,96,122,137,145,155,175,189,203,223,233,251,274,281,296,306,318,330,349] );

let slotMapIfcRoleEnum = new Int32Array( [8,4,12,19,22,10,20,14,7,0,11,6,1,5,16,9,15,17,3,21,18,2,13] );

let encodedDataIfcRoleEnum = (new TextEncoder()).encode( ".BUILDINGOWNER..ARCHITECT..PROJECTMANAGER..CONSTRUCTIONMANAGER..USERDEFINED..MECHANICALENGINEER..FIELDCONSTRUCTIONMANAGER..CIVILENGINEER..CLIENT..SUPPLIER..ELECTRICALENGINEER..COSTENGINEER..MANUFACTURER..STRUCTURALENGINEER..ENGINEER..BUILDINGOPERATOR..COMMISSIONINGENGINEER..OWNER..SUBCONTRACTOR..RESELLER..CONSULTANT..CONTRACTOR..FACILITIESMANAGER." );
