...
{    
    ...
    private ItemReference_? : string | null;
    ...
    public get ItemReference() : string | null
    {
        if ( this.ItemReference_ === void 0 )
        {
            this.ItemReference_ = (() => { this.guaranteeVTable();
        ...
        return this.ItemReference_ as string | null;
    }
