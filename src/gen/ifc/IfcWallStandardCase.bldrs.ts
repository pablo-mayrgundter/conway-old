...
{    
    public readonly specification: IfcWallStandardCaseSpecification = IfcWallStandardCaseSpecification.instance;
...
export class IfcWallStandardCaseSpecification implements ComponentSpecification
{
    ...
    public readonly required: ReadonlyArray< string > = [ 'IfcWallStandardCase', 'IfcWall', 'IfcBuildingElement', 'IfcElement', 'IfcProduct', 'IfcObject', 'IfcObjectDefinition', 'IfcRoot' ];
