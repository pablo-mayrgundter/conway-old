...
{    
    public readonly specification: IfcCircleHollowProfileDefSpecification = IfcCircleHollowProfileDefSpecification.instance;
...
export class IfcCircleHollowProfileDefSpecification implements ComponentSpecification
{
    ...
    public readonly required: ReadonlyArray< string > = [ 'IfcCircleHollowProfileDef', 'IfcCircleProfileDef', 'IfcParameterizedProfileDef', 'IfcProfileDef' ];
