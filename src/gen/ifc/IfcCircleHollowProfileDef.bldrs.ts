...
{    
    ...
    public static readonly query = [ EntityTypesIfc.IFCCIRCLEHOLLOWPROFILEDEF ];

    public static readonly expectedType: EntityTypesIfc = EntityTypesIfc.IFCCIRCLEHOLLOWPROFILEDEF;
}
