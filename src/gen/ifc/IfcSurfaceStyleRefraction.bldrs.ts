...
export  class IfcSurfaceStyleRefraction extends StepEntityBase< EntityTypesIfc > 
{    
    ...
    public get RefractionIndex() : IfcReal | null
    {
        ...
        {
            this.RefractionIndex_ = (() => { this.guaranteeVTable();
    ...
    public get DispersionFactor() : IfcReal | null
    {
        ...
        {
            this.DispersionFactor_ = (() => { this.guaranteeVTable();
