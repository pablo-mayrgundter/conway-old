...
export  class IfcRepresentation extends StepEntityBase< EntityTypesIfc > 
{    
    ...
    public get ContextOfItems() : IfcRepresentationContext
    {
        ...
        {
            this.ContextOfItems_ = (() => { this.guaranteeVTable();
    ...
    public get RepresentationIdentifier() : string | null
    {
        ...
        {
            this.RepresentationIdentifier_ = (() => { this.guaranteeVTable();
    ...
    public get RepresentationType() : string | null
    {
        ...
        {
            this.RepresentationType_ = (() => { this.guaranteeVTable();
    ...
    public get Items() : Array<IfcRepresentationItem>
    {
        ...
        {
            this.Items_ = (() => { this.guaranteeVTable();
