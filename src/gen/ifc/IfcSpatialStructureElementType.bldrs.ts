 ...
 */
export default abstract class IfcSpatialStructureElementType extends IfcElementType 
{    
    public readonly specification: IfcSpatialStructureElementTypeSpecification = IfcSpatialStructureElementTypeSpecification.instance;
...
export class IfcSpatialStructureElementTypeSpecification implements ComponentSpecification
{
    ...
    public readonly required: ReadonlyArray< string > = [ 'IfcSpatialStructureElementType', 'IfcElementType', 'IfcTypeProduct', 'IfcTypeObject', 'IfcObjectDefinition', 'IfcRoot' ];
