...
let prefixSumAddressIfcFireSuppressionTerminalTypeEnum =
  new Uint32Array( [0,13,24,37,57,67,79,95] )

let slotMapIfcFireSuppressionTerminalTypeEnum =
  new Int32Array( [5,3,1,4,2,6,0] )

let encodedDataIfcFireSuppressionTerminalTypeEnum =
  (new TextEncoder()).encode( ".USERDEFINED..SPRINKLER..FIREHYDRANT..SPRINKLERDEFLECTOR..HOSEREEL..NOTDEFINED..BREECHINGINLET." )
