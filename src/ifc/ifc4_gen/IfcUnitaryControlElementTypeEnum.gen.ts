...
let gMapIfcUnitaryControlElementTypeEnum =
  new Int32Array( [-4,5,64] )

let prefixSumAddressIfcUnitaryControlElementTypeEnum =
  new Uint32Array( [0,12,26,38,54,67,79,91,110,122,138] )

let slotMapIfcUnitaryControlElementTypeEnum =
  new Int32Array( [9,1,4,7,8,6,0,2,5,3] )

let encodedDataIfcUnitaryControlElementTypeEnum =
  (new TextEncoder()).encode( ".NOTDEFINED..CONTROLPANEL..MIMICPANEL..WEATHERSTATION..USERDEFINED..THERMOSTAT..ALARMPANEL..GASDETECTIONPANEL..HUMIDISTAT..INDICATORPANEL." )
