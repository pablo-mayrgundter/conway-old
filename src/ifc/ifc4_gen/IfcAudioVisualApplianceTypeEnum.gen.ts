...
let gMapIfcAudioVisualApplianceTypeEnum =
  new Int32Array( [5,345,71,5] )

let prefixSumAddressIfcAudioVisualApplianceTypeEnum =
  new Uint32Array( [0,7,19,30,43,51,62,74,83,93,102,113,121,131] )

let slotMapIfcAudioVisualApplianceTypeEnum =
  new Int32Array( [10,12,9,11,1,0,3,7,6,2,5,4,8] )

let encodedDataIfcAudioVisualApplianceTypeEnum =
  (new TextEncoder()).encode( ".TUNER..NOTDEFINED..TELEPHONE..USERDEFINED..CAMERA..AMPLIFIER..MICROPHONE..SPEAKER..RECEIVER..DISPLAY..PROJECTOR..PLAYER..SWITCHER." )
