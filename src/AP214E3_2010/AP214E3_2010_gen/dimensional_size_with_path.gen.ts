...
///**
// * http://www.buildingsmart-tech.org/ifc/ifc4/final/html/link/dimensional_size_with_path.htm */
export  class dimensional_size_with_path extends dimensional_size {
  public get type(): EntityTypesIfc {
    return EntityTypesIfc.DIMENSIONAL_SIZE_WITH_PATH
  }
  private path_? : shape_aspect

  public get path() : shape_aspect {
    if ( this.path_ === void 0 ) {
      this.path_ = this.extractElement( 2, false, shape_aspect )
    }
  ...
  public static readonly query = 
    [ EntityTypesIfc.DIMENSIONAL_SIZE_WITH_PATH ]
