...
export  class text_string_representation extends representation {
  ...
  public override get items() : Array<text_literal | annotation_text | annotation_text_character | defined_character_glyph | composite_text | axis2_placement_2d | axis2_placement_3d> {
