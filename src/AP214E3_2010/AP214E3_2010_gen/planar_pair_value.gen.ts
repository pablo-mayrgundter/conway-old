...
export  class planar_pair_value extends pair_value {
  ...
  private SELF\pair_value.applies_to_pair_? : planar_pair
  private actual_rotation_? : number
  private actual_translation_x_? : number
  private actual_translation_y_? : number

  public get SELF\pair_value.applies_to_pair() : planar_pair {
    if ( this.SELF\pair_value.applies_to_pair_ === void 0 ) {
      this.SELF\pair_value.applies_to_pair_ = this.extractElement( 1, false, planar_pair )
    }

    return this.SELF\pair_value.applies_to_pair_ as planar_pair
  }
