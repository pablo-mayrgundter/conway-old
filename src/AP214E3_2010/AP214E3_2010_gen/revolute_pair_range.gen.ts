...
export  class revolute_pair_range extends simple_pair_range {
  ...
  private SELF\simple_pair_range.applies_to_pair_? : revolute_pair
  ...
  public get SELF\simple_pair_range.applies_to_pair() : revolute_pair {
    if ( this.SELF\simple_pair_range.applies_to_pair_ === void 0 ) {
      this.SELF\simple_pair_range.applies_to_pair_ = this.extractElement( 1, false, revolute_pair )
    }

    return this.SELF\simple_pair_range.applies_to_pair_ as revolute_pair
  }
