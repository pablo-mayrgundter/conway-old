...
///**
// * http://www.buildingsmart-tech.org/ifc/ifc4/final/html/link/screw_pair_range.htm */
export  class screw_pair_range extends simple_pair_range {
  public get type(): EntityTypesIfc {
    return EntityTypesIfc.SCREW_PAIR_RANGE
  }
  private SELF\simple_pair_range.applies_to_pair_? : screw_pair
  ...
  public get SELF\simple_pair_range.applies_to_pair() : screw_pair {
    if ( this.SELF\simple_pair_range.applies_to_pair_ === void 0 ) {
      this.SELF\simple_pair_range.applies_to_pair_ = this.extractElement( 1, false, screw_pair )
    }

    return this.SELF\simple_pair_range.applies_to_pair_ as screw_pair
  }
  ...
  public static readonly query = 
    [ EntityTypesIfc.SCREW_PAIR_RANGE ]
