...
export  class planar_pair_range extends simple_pair_range {
  ...
  private SELF\simple_pair_range.applies_to_pair_? : planar_pair
  ...
  public get SELF\simple_pair_range.applies_to_pair() : planar_pair {
    if ( this.SELF\simple_pair_range.applies_to_pair_ === void 0 ) {
      this.SELF\simple_pair_range.applies_to_pair_ = this.extractElement( 1, false, planar_pair )
    }

    return this.SELF\simple_pair_range.applies_to_pair_ as planar_pair
  }
