...
export  class not_expression extends unary_boolean_expression {
  ...
  private SELF\unary_generic_expression.operand_? : boolean_expression

  public get SELF\unary_generic_expression.operand() : boolean_expression {
    if ( this.SELF\unary_generic_expression.operand_ === void 0 ) {
      this.SELF\unary_generic_expression.operand_ = this.extractElement( 0, false, boolean_expression )
    }

    return this.SELF\unary_generic_expression.operand_ as boolean_expression
  }
  constructor(
    localID: number,
